...
use common\components\RbsDiscount;
...
class Rbs
{
     ...
     */
    public function register_order($order_number, $amount, $return_url, $fail_url = '', $currency_code = 643, $orderBundle = null)
    {
    ...
    private function gateway($method, $data)
    {
        ...
        curl_setopt_array($curl, array(
            ...
            CURLOPT_HTTPHEADER => array('CMS: EGRUL 2.0', 'Module-Version: ' . $this->version),
        ));
    ...
    {
        Logger::paymentLog("RBS PAYMENT",  $url . $method . "\nREQUEST: " . json_encode($request) . "\nRESPONSE: " . $response . "\n\n");
    }
