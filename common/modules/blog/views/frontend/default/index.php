...
?>
<div class="section-portfolio section-blog further-back-block" data-further="/contact" data-back="/prices">
    <div class="container">
        <h1><?= $seo['h1']; ?></h1>
        <h2><?= $seo['h2']; ?></h2>
        ...
        <? if ($next && $query->count()) { ?>
            <div class="row load-block">
                <div class="col-sm-12 text-center">
                    <a data-pjax="0" href="javascript:void" class="load-next-page" title="Загрузить еще" data-container=".blog-container" data-action="/blog/default/page">
        ...
        <div class="row">
            <div class="col-sm-12 sm-text-right">
                <a href="/blog/all" class="back-works blog-back"><span class="hidden-xs">Все статьи</span>
