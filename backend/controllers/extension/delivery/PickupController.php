...
namespace backend\controllers\extension\delivery;
...
/**
 * PickupController implements the CRUD actions for Delivery model.
 */
class PickupController extends Controller
{

    public $groupClass = 'Pickup';
    ...
    public function actionIndex()
    {
        ...
        $query = ModuleGroup::find()
          ->where(['category' => 'delivery', 'code' => $this->groupClass]);
    ...
    {
        if (($model = ModuleGroup::findOne(['category' => 'delivery', 'code' => $this->groupClass])) !== null) {
            return $model;
        }
