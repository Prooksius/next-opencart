...
/**
 * LookedProductsController implements the CRUD actions for LookedProducts model.
 */
class LookedProductsController extends Controller
{

    public $groupClass = 'LookedProducts';
