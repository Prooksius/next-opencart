...
/**
 * ModulesController implements the CRUD actions for ModuleGroup model.
 */
class ModulesController extends Controller
{
    ...
    public function actionIndex()
    {
        ...
        $query = ModuleGroup::find()
          ...
          ->select([
            'mg.*',
            '(SELECT COUNT(m.id) FROM oc_module m WHERE m.module_group_id = mg.id) AS instances'
          ])
          ->where(['mg.category' => 'module']);
