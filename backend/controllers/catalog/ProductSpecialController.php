...
/**
 * ProductSpecialController implements the CRUD actions for ProductSpecial model.
 */
class ProductSpecialController extends Controller
{
  ...
  /**
   * Updates an existing ProductSpecial model.
  ...
  /**
   * Deletes an existing ProductSpecial model.
  ...
  /**
   * Finds the ProductSpecial model based on its primary key value.
   * If the model is not found, a 404 HTTP exception will be thrown.
   * @param integer $id
   * @return ProductSpecial the loaded model
   * @throws NotFoundHttpException if the model cannot be found
   */
  protected function findModel($id)
  {
    if (($model = ProductSpecial::findOne($id)) !== null) {
      return $model;
    }
