...
$this->title = Yii::t('product', 'Discount prices') . ': ' . $product_name;
$this->params['breadcrumbs'][] = ['label' => Yii::t('product', 'Products'), 'url' => ['/catalog/product']];
$this->params['breadcrumbs'][] = Yii::t('product', 'Discount prices');
?>
<div class="reviews-index">

  <p>
      <?= Html::a(Yii::t('product', 'Add discount'), ['create', 'product_id' => $product_id], ['class' => 'btn btn-success']) ?>
  </p>
