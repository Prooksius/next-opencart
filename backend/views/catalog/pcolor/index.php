...
$this->title = Yii::t('product', 'Product Colors');
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="reviews-index">

    <p>
        <?= Html::a(Yii::t('product', 'Add Product Color'), ['create'], ['class' => 'btn btn-success']) ?>
    </p>
    ...
    <?= GridView::widget([
        ...
        'columns' => [
            [
              ...
              'value' => function ($data) {
                return html::a(EasyThumbnailImage::thumbnailImg(
                  '@root' . ($data->image ?  $data->image : "/upload/image/placeholder.png"),
                  40,
                  40,
            ...
            [
                ...
                'value' => function ($data) {
                    $html  = html::beginForm(Url::to(['catalog/pcolor/update', 'id' => $data->id]), 'POST', ['style' => 'display: inline-block;margin-left: 10px;vertical-align: middle;']);
