...
<div class="reviews-index">
  ...
  <p>
      <?= Html::a(YII::t('blog', 'Add Blog Category'), ['create', 'parent_id' => $parent_id], ['class' => 'btn btn-success']) ?>
      <?php if ($up_level != -1) { ?>
  ...
  <?= GridView::widget([
    ...
    'columns' => [
      ...
      [
        ...
        'value' => function ($data) {
          return $data->article_count . '&nbsp;&nbsp;&nbsp;' . html::a(
             YII::t('blog', 'Articles'), 
            ['/catalog/blog-article/index', 'BlogArticleSearch[category_id]' => $data->id], 
      ...
      [
        ...
        'value' => function ($data) {
          $html  = html::beginForm(Url::to(['catalog/blog-category/update', 'id' => $data->id]), 'POST', ['style' => 'display: inline-block;margin-left: 10px;vertical-align: middle;']);
