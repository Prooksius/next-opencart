...
<div class="total-form">
  ...
  <?= MyHtml::formGroupLang('ModuleGroup', 'settingsArr[description]', 'Описание', $model->settingsArr['description'], [], $model->languagesList)?>

  <?= MyHtml::formGroup('ModuleGroup', 'settingsArr[price]', 'Стоимость', $model->settingsArr['price'])?>
